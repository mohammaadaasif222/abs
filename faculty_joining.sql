...
CREATE TABLE `faculty_joining` (
  ...
  `date_of_appointment` varchar(45) DEFAULT NULL,
  `date_of_retirement` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2024-05-25 15:08:51
